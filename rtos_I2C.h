...
typedef enum {rtos_I2C0, rtos_I2C1, rtos_I2C2, rtos_I2C3} rtos_I2C_channel_t;
typedef enum {rtos_Slave_mode,          rtos_Master_mode} master_or_slave_mode_t;
typedef enum {rtos_I2C_READ_mode,    rtos_I2C_WRITE_mode} transmit_mode_t;
...
uint8_t  I2C_read_byte(rtos_I2C_channel_t I2C_number, uint8_t * buffer, uint16_t lenght,
